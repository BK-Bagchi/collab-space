...
const CtaSection = () => {
  ...
  return (
    <section className="text-center py-20 px-8 md:px-16 bg-linear-to-br from-electricBlue/20 via-vibrantPurple/20 to-tealGreen/20">
      ...
      <Link
        ...
        className="px-8 py-3 bg-electricBlue font-semibold rounded-lg hover:bg-[#1E63D0] transition text-white logo-font"
      >
        Start Free Today
      </Link>
    </section>
