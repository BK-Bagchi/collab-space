...
const Banner = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between min-h-[50vh] px-8 md:px-16 py-20 bg-linear-to-br from-electricBlue via-vibrantPurple to-tealGreen text-white shadow-lg">
