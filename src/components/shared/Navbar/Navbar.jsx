...
const Navbar = () => {
  ...
  return (
    <div className="navbar sticky top-0 z-50 bg-electricBlue dark:bg-darkSlate text-softWhite shadow-sm px-3 border-b border-gray-500">
      <div className="navbar-start">
        <div className="dropdown lg:hidden">
          ...
          <ul
            tabIndex="-1"
            className="menu menu-sm body-font bg-electricBlue dark:bg-darkSlate dropdown-content rounded-box z-1 mt-3 w-52 p-2 shadow"
          >
            {loggedIn ? (
              <>
                <PrivateList />
