            ...
            {selectedMembers.map((m) => (
              <div key={m._id} className="relative">
                ...
                <button
                  ...
                  className="absolute -top-1.5 -right-1.5 bg-white border border-gray-300 rounded-full p-0.5 hover:bg-red-100 hover:border-red-400 transition"
                  title="Remove member"
                >
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      {isSelected && (
                        <div className="absolute bottom-0 right-0 bg-electricBlue text-white rounded-full p-0.5">
